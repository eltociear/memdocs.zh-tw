...
若要建立其他平台的 kiosk 設定檔，請參閱 [Android 裝置系統管理員](device-restrictions-android.md#kiosk)、[Android Enterprise](device-restrictions-android-for-work.md#device-experience) 和 [iOS/iPadOS](device-restrictions-ios.md#kiosk)。
