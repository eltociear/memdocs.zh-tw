...
3. 確認 [Intune 授權] 和 [帳戶狀態] 同時顯示綠色核取記號：
    ...
    :::image type="content" source="./media/troubleshoot-policies-in-microsoft-intune/account-status-intune-license-show-green.png" alt-text="在 Intune 中選取使用者，並確認 [帳戶狀態] 和 [Intune 授權] 都顯示綠色核取記號狀態。":::
