...
:::image type="content" source="./media/device-profile-create/create-device-profile.png" alt-text="在 Microsoft Intune 中建立 iOS/iPadOS 設定檔。":::
...
1. 選取 [適用性規則]。 您可以選擇 [規則] 和 [屬性]：

    :::image type="content" source="./media/device-profile-create/applicability-rules.png" alt-text="在 Microsoft Intune 中新增 Windows 10 裝置組態設定檔的適用性規則。":::
...
- 將使用者原則與裝置原則分開。
  ...
  例如，[Intune 中的系統管理範本](administrative-templates-windows.md)有數百項 ADMX 設定。 這些範本會顯示設定是否適用於使用者或裝置。 建立系統管理範本時，將您的使用者設定指派給使用者群組，並將您的裝置設定指派給裝置群組。
