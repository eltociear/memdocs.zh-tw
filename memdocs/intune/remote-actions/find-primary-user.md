...
>2. 變更裝置的主要使用者並不會對本機群組成員資格進行任何變更，例如，從 "Administrators" 本機群組新增或移除使用者
>3. 變更主要使用者並不會變更「註冊者為」使用者。 
...
針對新註冊的 Azure AD 裝置，Azure AD **擁有者**屬性會在設定 Intune 主要使用者時自動設定。
