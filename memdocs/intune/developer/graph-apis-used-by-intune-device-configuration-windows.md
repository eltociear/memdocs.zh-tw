...
下列清單顯示 Windows 10 裝置設定 Microsoft Intune 所使用的大部分圖形 API 實體。 它也會顯示對應的 Windows 10 CSP 和位移 URI。
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Defender/SignatureUpdateInterval
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/AllowDeveloperUnlock
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/System/AllowUserToResetPhone
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowManualMDMUnenrollment
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/System/AllowTelemetry
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Display/TurnOffGdiDPIScalingForApps
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Display/TurnOnGdiDPIScalingForApps
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/HomePages
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/PreventAccessToAboutFlagsInMicrosoftEdge
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/AllowInPrivate
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/AllowSearchSuggestionsinAddressBar
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/AllowDoNotTrack
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/SendIntranetTraffictoInternetExplorer
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/AllowWebContentOnNewTabPage
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/EnterpriseSiteListServiceUrl
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/SetHomeButtonURL
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/ConfigureHomeButton
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/ShowMessageWhenOpeningSitesInInternetExplorer
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/SyncFavoritesBetweenIEAndMicrosoftEdge
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/ConfigureTelemetryForMicrosoft365Analytics
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/CredentialProviders/DisableAutomaticReDeploymentCredentials
...
**位移 URI**：/Config/EnterpriseCloudPrint/CloudPrinterDiscoveryEndPoint
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/EnterpriseCloudPrint/DiscoveryMaxPrinterLimit
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/EnterpriseCloudPrint/MopriaDiscoveryResourceId
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/EnterpriseCloudPrint/CloudPrintOAuthAuthority
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/EnterpriseCloudPrint/CloudPrintResourceId
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowWindowsConsumerFeatures
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowDeviceDiscovery
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowSIMErrorDialogPromptWhenNoSIM
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowTaskSwitcher
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowWindowsSpotlight
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/DoNotSyncBrowserSettings

### <a name="windows10generalconfigurationgamedvrblocked"></a>Windows10GeneralConfiguration.GameDvrBlocked 
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/AllowGameDVR
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceInstallation/PreventInstallationOfMatchingDeviceIDs
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceInstallation/PreventInstallationOfMatchingDeviceSetupClasses

### <a name="windows10generalconfigurationinkworkspaceaccess"></a>Windows10GeneralConfiguration.InkWorkspaceAccess 
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/WindowsInkWorkspace/AllowWindowsInkWorkspace
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/WindowsInkWorkspace/AllowSuggestedAppsInWindowsInkWorkspace
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DoNotAllowActiveXControlsInProtectedMode
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/AllowAutoComplete
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DoNotBlockOutdatedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableBypassOfSmartScreenWarnings
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableBypassOfSmartScreenWarningsAboutUncommonFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/AllowCertificateAddressMismatchWarning
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/CheckServerCertificateRevocation
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/CheckSignaturesOnDownloadedPrograms
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableCrashDetection
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableProcessesInEnhancedProtectedMode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableEnclosureDownloading
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableEncryptionSupport
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/AllowEnhancedProtectedMode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/AllowFallbackToSSL3
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableIgnoringCertificateErrors
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/IncludeAllNetworkPaths
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowAccessToDataSources
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowOnlyApprovedDomainsToUseActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowOnlyApprovedDomainsToUseTDCActiveXControl
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowVBScriptToRunInInternetExplorer
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowAutomaticPromptingForFileDownloads
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowCopyPasteViaScript
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneEnableCrossSiteScriptingFilter
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowNETFrameworkReliantComponents
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneDownloadSignedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneDownloadUnsignedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowDragAndDropCopyAndPasteFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneEnableDraggingOfContentFromDifferentDomainsAcrossWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneEnableDraggingOfContentFromDifferentDomainsWithinWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneIncludeLocalPathWhenUploadingFilesToServer
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneInitializeAndScriptActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneLaunchingApplicationsAndFilesInIFRAME
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowLessPrivilegedSites
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowLoadingOfXAMLFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneLogonOptions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneNavigateWindowsAndFrames
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneUsePopupBlocker
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneEnableProtectedMode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneRunNETFrameworkReliantComponentsSignedWithAuthenticode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowScriptingOfInternetExplorerWebBrowserControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowScriptInitiatedWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowScriptlets
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneShowSecurityWarningForPotentiallyUnsafeFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowSmartScreenIE
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowUpdatesToStatusBarViaScript
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/InternetZoneAllowUserDataPersistence
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/IntranetZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/IntranetZoneInitializeAndScriptActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/IntranetZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LocalMachineZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LocalMachineZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownInternetZoneAllowSmartScreenIE
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownIntranetJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownLocalMachineZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownRestrictedSitesZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownRestrictedSitesZoneAllowSmartScreenIE
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/LockedDownTrustedSitesZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/PreventManagingSmartScreenFilter
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/PreventPerUserInstallationOfActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/ConsistentMimeHandlingInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/MimeSniffingSafetyFeatureInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/MKProtocolSecurityRestrictionInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/NotificationBarInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/ProtectionFromZoneElevationInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictActiveXInstallInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictFileDownloadInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/ScriptedWindowSecurityRestrictionsInternetExplorerProcesses
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RemoveRunThisTimeButtonForOutdatedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowAccessToDataSources
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowActiveScripting
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseTDCActiveXControl
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowVBScriptToRunInInternetExplorer
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowAutomaticPromptingForFileDownloads
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowBinaryAndScriptBehaviors
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowCopyPasteViaScript
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneEnableCrossSiteScriptingFilter
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowNETFrameworkReliantComponents
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneDownloadSignedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneDownloadUnsignedActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowDragAndDropCopyAndPasteFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneEnableDraggingOfContentFromDifferentDomainsAcrossWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneEnableDraggingOfContentFromDifferentDomainsWithinWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowFileDownloads
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneIncludeLocalPathWhenUploadingFilesToServer
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneInitializeAndScriptActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneLaunchingApplicationsAndFilesInIFRAME
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowLessPrivilegedSites
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowLoadingOfXAMLFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneLogonOptions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowMETAREFRESH
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneNavigateWindowsAndFrames
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneUsePopupBlocker
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneTurnOnProtectedMode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneRunActiveXControlsAndPlugins
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneRunNETFrameworkReliantComponentsSignedWithAuthenticode
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneScriptActiveXControlsMarkedSafeForScripting
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneScriptingOfJAVAApplets
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowScriptingOfInternetExplorerWebBrowserControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowScriptInitiatedWindows
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowScriptlets
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneShowSecurityWarningForPotentiallyUnsafeFiles
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowSmartScreenIE
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowUpdatesToStatusBarViaScript
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/RestrictedSitesZoneAllowUserDataPersistence
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DisableSecuritySettingsCheck
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/SecurityZonesUseOnlyMachineSettings
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/AllowSoftwareWhenSignatureIsInvalid
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/TrustedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/TrustedSitesZoneInitializeAndScriptActiveXControls
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/TrustedSitesZoneJAVAPermissions
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/SpecifyUseOfActiveXInstallerService
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/InternetExplorer/DoNotAllowUsersToAddSites
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/AllowScreenTimeoutWhileLockedUser/Config
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/AboveLock/AllowActionCenterNotifications
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/WindowsLogon/DontDisplayNetworkSelectionUI

### <a name="windows10generalconfigurationlockscreenslideshow"></a>Windows10GeneralConfiguration.LockScreenSlideShow 
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/PreventLockScreenSlideShow
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/ScreenTimeoutWhileLocked
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowSyncMySettings
...
**位移 URI**：/AllowMicrosoftAccountSignInAssistant
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/MaxInactivityTimeDeviceLock
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/AllowIdleReturnWithoutPassword
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/DeviceLock/MaxDevicePasswordFailedAttempts
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Power/RequirePasswordWhenComputerWakesOnBattery
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Power/RequirePasswordWhenComputerWakesPluggedIn
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Power/AllowStandbyStatesWhenSleepingOnBattery
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Power/AllowStandbyWhenSleepingPluggedIn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Privacy/AllowInputPersonalization
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Search/AlwaysUseAutoLangDetection
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Search/DisableBackoff
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Search/AllowIndexingEncryptedStoresOrItems
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Security/PreventAutomaticDeviceEncryptionForAzureADJoinedDevices

### <a name="windows10generalconfigurationsettingsblockaccountspage"></a>Windows10GeneralConfiguration.SettingsBlockAccountsPage 
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Settings/PageVisibilityList
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Security/AllowAddProvisioningPackage
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Settings/AllowLanguage
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Settings/AllowDateTime
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Settings/AllowEditDeviceName
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Security/AllowRemoveProvisioningPackage
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/AllowSharedUserAppData
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/PreventSmartScreenPromptOverride
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/PreventSmartScreenPromptOverrideForFiles
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/SmartScreen/EnableAppInstallControl
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/NoPinningToTaskbar
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/HideAppList
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/HideChangeAccountSettings
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/HideRecentJumplists
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/HideRecentlyAddedApps
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderDocuments
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderDownloads
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderFileExplorer
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderHomeGroup
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderMusic
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderNetwork
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderPersonalFolder
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderPictures
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderSettings
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Start/AllowPinnedFolderVideos
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/System/AllowStorageCard
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Security/RequireDeviceEncryption
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/RestrictAppDataToSystemVolume
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/RestrictAppToSystemVolume
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/PreventUsingLocalHostIPAddressForWebRTC
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/WindowsLogon/EnumerateLocalUsersOnDomainJoinedComputers
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowWindowsSpotlightOnActionCenter
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowTailoredExperiencesWithDiagnosticData
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowThirdPartySuggestionsInWindowsSpotlight
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowWindowsSpotlightWindowsWelcomeExperience
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/AllowWindowsTips
...
**CSP**：./User/Vendor/MSFT/Policy  
**位移 URI**：/Config/Experience/ConfigureWindowsSpotlightOnLockScreen
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/ApplicationManagement/RequirePrivateStoreOnly
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/WirelessDisplay/AllowProjectionToPC
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/WirelessDisplay/AllowUserInputFromWirelessDisplayReceiver
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/WirelessDisplay/RequirePINForPairing
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/ControlPolicyConflict/MDMWinsOverGP
...
**OFFSET URI**：/MOMAgent/WorkspaceID 和/MOMAgent/WorkspaceKey
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/InBoxApps/Connect/AutoLaunch
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/DeviceAccount/ExchangeServer
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/DeviceAccount/PasswordRotationEnabled
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/DeviceAccount/SipAddress
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**OFFSET URI**：/MaintenanceHoursSimple/Hours/Duration 和/MaintenanceHoursSimple/Hours/StartTime
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/MaintenanceHoursSimple/Hours/Duration
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/Properties/DoNotShowMyMeetingsAndFiles
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/Properties/AllowSessionResume
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/Properties/ScreenTimeout
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/Properties/SessionTimeout
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/Properties/SleepTimeout
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/InBoxApps/Welcome/CurrentBackgroundPath
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/InBoxApps/Welcome/AutoWakeScreen
...
**CSP**：./Vendor/MSFT/SurfaceHub  
**位移 URI**：/InBoxApps/Welcome/MeetingInfoOption
...
**CSP**：./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**位移 URI**：/Configuration/SampleSharing
...
**CSP**：./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**位移 URI**：/Configuration/TelemetryReportingFrequency
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/DeliveryOptimization/DODownloadMode
...
**位移 URI**：/Biometrics/FacialFeaturesUseEnhancedAntiSpoofing
...
**位移 URI**：/{AADTenantId}/Policies/PINComplexity/Expiration
...
**CSP**：./Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/PINComplexity/History
...
**CSP**：./Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/EnablePinRecovery
...
**CSP**：./Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/PINComplexity/SpecialCharacters
...
**CSP**：./Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/PINComplexity/UppercaseLetters
...
**CSP**：./Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/RequireSecurityDevice
...
**CSP**：./Device/Vendor/MSFT/PassportForWork  
**位移 URI**：/Biometrics/UseBiometrics
...
**CSP**：./Device/Vendor/MSFT/PassportForWork  
**位移 URI**：/{AADTenantId}/Policies/UseCertificateForOnPremAuth
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Browser/ConfigureKioskResetAfterIdleTimeout
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/KioskBrowser/EnableNavigationButtons
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/KioskBrowser/KioskBrowserRestartOnIdleTimeInMinutes
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/AllowAutoUpdate
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/AutoRestartRequiredNotificationDismissal
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/BranchReadinessLevel
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/ExcludeWUDriversInQualityUpdate
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartDeadlineForFeatureUpdates
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartDeadline
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartSnoozeScheduleForFeatureUpdates
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartSnoozeSchedule
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartTransitionScheduleForFeatureUpdates
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/EngagedRestartTransitionSchedule
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/DeferFeatureUpdatesPeriodInDays
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/PauseFeatureUpdates
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/PauseFeatureUpdatesStartTime
...
**CSP**： n/a-僅圖形 API**位移 URI**： n/a-僅圖形 API
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/AllowMUUpdateService
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/ManagePreviewBuilds
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/DeferQualityUpdatesPeriodInDays
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/PauseQualityUpdates
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/PauseQualityUpdatesStartTime
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/ScheduleImminentRestartWarning
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/ScheduleRestartWarning
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/SetEDURestart
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/SetDisablePauseUXAccess


## <a name="next-steps"></a>後續步驟

- [裝置設定總覽](../configuration/device-profiles.md)
- 設定[服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference)（開啟另一個檔網站）
