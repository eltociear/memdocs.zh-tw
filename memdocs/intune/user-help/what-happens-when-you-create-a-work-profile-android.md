...
- 工作應用程式圖示具有「徽章」，其看起來像是紅色圓形內的白色公事包，如下所示。 個人應用程式圖示不會顯示公事包，且看起來與現在的外觀相同。
...
如需建立工作設定檔的步驟，請參閱[建立工作設定檔並註冊您的裝置](enroll-device-android-work-profile.md)。
