...
身為 Microsoft Intune 系統管理員，您可以控制要在受控裝置的 Microsoft 應用程式中新增的公司或學校帳戶。 您可以僅允許組織使用者帳戶進行存取，並封鎖已註冊裝置上的個人帳戶。 針對 iOS/iPadOS 裝置，請在受控裝置應用程式設定原則中使用下列金鑰/值組：
