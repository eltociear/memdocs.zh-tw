...
Configuration Manager 用戶端安裝程式 ccmsetup 可以從本機來源或透過管理點取得安裝內容。 其初始行為取決於您用來安裝用戶端的命令列參數：<!-- MEMDocs#286 -->
...
如需這些 ccmsetup 參數的詳細資訊，請參閱[用戶端安裝參數和內容](../../../clients/deploy/about-client-installation-properties.md)。
