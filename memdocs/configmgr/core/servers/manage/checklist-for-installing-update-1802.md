...
當使用 Configuration Manager 的最新分支時，可以安裝 1802 版的主控台內更新，以更新您舊版的階層。 <!-- baseline only statement: -->(因為 1802 版也可作為[基準媒體](updates.md#bkmk_Baselines)，所以您可以使用安裝媒體來安裝新階層的第一個站台。)
