...
當您使用 Configuration Manager 的最新分支時，可以安裝 1806 版的主控台內更新，以從舊版更新您的階層。 <!-- baseline only statement: (Because version 1802 is also available as [baseline media](updates.md#a-namebkmkbaselinesa-baseline-and-update-versions), you can use the installation media to install the first site of a new hierarchy.)-->
...
在更新站台之前，請在 Configuration Manager 伺服器上停止防毒軟體。 <!--SMS.503481--> 
