...
description: 了解 Configuration Manager Technical Preview 2001.2 分支版本中可用的新功能。
ms.date: 02/03/2020
...
ms.locfileid: "84226311"
---
# <a name="features-in-configuration-manager-technical-preview-version-20012"></a>Configuration Manager Technical Preview 2001.2 版中的功能

適用於：  Configuration Manager (Technical Preview 分支)

本文介紹 Configuration Manager Technical Preview 2001.2 版中可用的功能。 安裝此版本進行更新，並將新功能新增到您的 Technical Preview 網站。
