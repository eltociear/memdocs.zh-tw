...
description: 了解 Configuration Manager Technical Preview 2006 分支版本中可用的新功能。
ms.date: 06/29/2020
...
ms.locfileid: "85590521"
---
# <a name="features-in-configuration-manager-technical-preview-version-2006"></a>Configuration Manager 2006 技術預覽版中的功能

適用於：Configuration Manager (Technical Preview 分支)

此文章介紹 Configuration Manager 2006 技術預覽版中可用的功能。 安裝此版本進行更新，並將新功能新增到您的 Technical Preview 網站。
