---
title: 使用 Windows Analytics 監視用戶端
titleSuffix: Configuration Manager
description: Windows Analytics 是一組解決方案，可讓您獲取環境目前狀態的實用深入解析。
ms.date: 01/31/2020
...
如果您的 Configuration Manager 站台與更新整備小幫手相連，則必須將其移除並重新設定用戶端。 如需詳細資訊，請參閱[移除更新整備小幫手連線](upgrade-readiness.md#bkmk_remove)。
