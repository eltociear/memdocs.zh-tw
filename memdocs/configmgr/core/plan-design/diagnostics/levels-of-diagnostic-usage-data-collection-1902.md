---
title: 1902 的診斷和使用方式資料
titleSuffix: Configuration Manager
description: 深入了解 Configuration Manager 在 1902 版每個層級收集的特定資料。
ms.date: 05/13/2019
...
針對 Configuration Manager 1902 版，這個層級包括下列資料：
...
- ***[新增]*** Microsoft BitLocker Administration and Monitoring (MBAM) 伺服器端擴充功能的存在  

- ***[新增]*** Asset Intelligence 的分類和未分類應用程式計數
...
- [已更新] 用戶端健全狀況統計資料和熱門問題摘要 (依用戶端版本、元件、OS 和工作負載)  
...
- ***[已更新]*** 資料倉儲服務點的設定，包括同步處理排程、平均時間和自訂資料表功能的使用  
...
- ***[新增]*** 有關電腦分析註冊錯誤和使用方式的統計資料

- ***[新增]*** 非關鍵主控台通知的計數

- ***[新增]*** 彙總系統開機時間統計資料 (依 OS、型式規格和磁碟機類型)
