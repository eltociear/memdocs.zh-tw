---
title: 1810 的診斷和使用方式資料
titleSuffix: Configuration Manager
description: 深入了解 Configuration Manager 在 1810 版每個層級收集的特定資料。
ms.date: 05/13/2019
...
ms.locfileid: "84506124"
---
# <a name="diagnostic-and-usage-data-for-version-1810"></a>1810 版的診斷及使用方式資料
...
針對 Configuration Manager 1810 版，這個層級包括下列資料：
...
- [已更新] 基本資料庫設定：處理器、記憶體大小、記憶體設定、Configuration Manager 資料庫設定、Configuration Manager 資料庫大小、叢集設定、分散式檢視的設定以及變更追蹤版本  
...
- [已更新] Windows 10 裝置計數 (依分支、組建和唯一 Active Directory 樹系)  
...
- [新增] 前幾名 SQL 查詢雜湊清單 (依記憶體使用量和鎖定計數)  

- [已移動、更新] 彙總的共同管理使用方式統計資料：曾註冊的用戶端數目、已註冊的用戶端數目、暫止註冊的用戶端數目、接收原則的用戶端、工作負載狀態、試驗/排除集合大小，以及註冊錯誤  
...
- [新增] 電子郵件核准功能使用方式的彙總統計資料  

- [新增] 應用程式類別目錄中的檔案計數、內容大小、服務計數和 MSI 的自訂動作計數  
...
- [新增] UUP 更新數目的彙總統計資料 (必要、已部署、已到期、已取代以及已下載)  

- [新增] UUP 產品類別目錄的使用  

- [新增] 已部署至少一個 UUP 品質更新或 UUP 功能更新的用戶端計數  

- [新增] 前幾名的 UUP 錯誤碼和受影響的裝置計數  
